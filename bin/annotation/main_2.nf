process AGT {
    ...
    agat_sp_filter_incomplete_gene_coding_models.pl --gff longest_${sample_code}.gff3 --fasta ${assembly_file} --output filtered_${sample_code}.gff3
    ...
    gffread final_${sample_code}.gff3 -g ${assembly_file} -x cds_${sample_code}.fa -y protein_${sample_code}.fa
