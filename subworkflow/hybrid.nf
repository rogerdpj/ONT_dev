...
include { AUTOCYCLER                                  }     from '../modules/assemble/autocycler/main'
include { DNAAPLER                                    }     from '../modules/assemble/autocycler/dnaapler'
include { FASTQC_QUALITY as FASTQC_QUALITY_ORIGINAL   }     from '../modules/qc/fastqc/main'
include { TRIMMING as SHORT_TRIMMING                  }     from '../modules/trimming/short_trimming'
include { FASTQC_QUALITY as FASTQC_QUALITY_FINAL      }     from '../modules/qc/fastqc/main'
include { MULTIQC_FASTQ                               }     from '../modules/qc/multiqc/main_2'
include { ALIGN_SHORT_READS;FILTER_ALIGNMENTS;POLISH  }     from '../modules/polishing/main_2'
include { WRAP                                        }     from '../modules/polishing/wrap'
